...
//This should be included in sendExitNotification (as a special case of exit from a study)
    ...
    public @ResponseBody String getParticipants(
        ...
        return researchCentreModel.getParticipants(studyID);
    }

    @GetMapping(value = "/getHelthDataByStudyAndParticipant", produces="application/json")
    public @ResponseBody String getHelthDataByStudy(
        ...
        return researchCentreModel.getHealthDataByStudy(studyID, participant).toString();
    }
}
