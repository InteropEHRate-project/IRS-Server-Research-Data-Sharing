...
//        jsonResponseBody.put("certificate", rcCertificateString);
    ...
    public static String getParticipants(String studyID) throws JsonProcessingException {
    ...
    public static JSONObject getHealthDataByStudy(String studyID, String participant) throws JSONException, IOException {
